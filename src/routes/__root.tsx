  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="text-xs uppercase tracking-[0.14em] text-primary font-medium">404</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SIX Sense — Enterprise Knowledge Continuity" },
      { name: "description", content: "Preserve expert reasoning, decisions, and organizational context across SIX Group." },
      { property: "og:title", content: "SIX Sense — Enterprise Knowledge Continuity" },
      { property: "og:description", content: "Knowledge continuity platform for SIX Group." },
